...
######################################################################################
# Create mesh object from obj-file
######################################################################################

def load_obj(filename, centre, clear_ks=True, mtl_override=None):
    ...
    vertices -= torch.tensor(centre, dtype=torch.float32, device='cuda')
